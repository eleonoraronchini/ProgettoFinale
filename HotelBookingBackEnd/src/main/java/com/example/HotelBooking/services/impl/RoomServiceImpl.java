...
public class RoomServiceImpl implements RoomService {
  ...
  /*  private String saveImage(MultipartFile imageFile) {
    ...
    private static final String IMAGE_DIRECTORY_FRONTEND = System.getProperty("user.home") + File.separator + "OneDrive" + File.separator + "Documenti" + File.separator + "EPICODE" + File.separator + "ProgettoFinale" + File.separator + "ProgettoFinale" + File.separator + "HotelBookingFrontEnd" + File.separator + "hotel-booking-fe" + File.separator + "public" + File.separator + "rooms" + File.separator;
